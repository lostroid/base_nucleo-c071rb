...
********************************************************************/
#ifndef H_BASE_ADC_TYPE_H
#define H_BASE_ADC_TYPE_H

#include "types.h"

#define d_BASE_ADC_LSB                              8007    //+ LSB 800.7uV
#define d_BASE_ADC_TO_VOLTAGE(D_ADC)                ((D_ADC * d_BASE_ADC_LSB) / 10000)
