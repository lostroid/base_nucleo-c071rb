...
#define d_BASE_GPIO_MT_POWER_H        (GPIOA->BSRR = GPIO_BSRR_BS8)
#define d_BASE_GPIO_MT_POWER_L        (GPIOA->BSRR = GPIO_BSRR_BR8)

#define d_BASE_GPIO_MT_OPEN_H         (GPIOA->BSRR = GPIO_BSRR_BS15)
#define d_BASE_GPIO_MT_OPEN_L         (GPIOA->BSRR = GPIO_BSRR_BR15)

#define d_BASE_GPIO_MT_CLOSE_H        (GPIOB->BSRR = GPIO_BSRR_BS3)
#define d_BASE_GPIO_MT_CLOSE_L        (GPIOB->BSRR = GPIO_BSRR_BR3)

#define d_BASE_GPIO_MAIN_POWER_H      (GPIOB->BSRR = GPIO_BSRR_BS6)
#define d_BASE_GPIO_MAIN_POWER_L      (GPIOB->BSRR = GPIO_BSRR_BR6)

#define d_BASE_GPIO_SW_OK_IN          (GPIOC->IDR & GPIO_IDR_ID6)
#define d_BASE_GPIO_SW_OK_A_IN        (GPIOA->IDR & GPIO_IDR_ID11)
#define d_BASE_GPIO_SW_OK_B_IN        (GPIOA->IDR & GPIO_IDR_ID12)
#define d_BASE_GPIO_MT_OPEN_IN        (GPIOB->IDR & GPIO_IDR_ID4)
#define d_BASE_GPIO_MT_CLOSE_IN       (GPIOB->IDR & GPIO_IDR_ID5)
#define d_BASE_GPIO_CHARGE_IN         (GPIOB->IDR & GPIO_IDR_ID7)
#define d_BASE_GPIO_SW_POWER          (GPIOB->IDR & GPIO_IDR_ID8)
...
void f_Base_GPIO_Init(void)
{
    ...
    f_Base_GPIO_Motor_Power_OnOff(m_GPIO_ON);
    f_Base_GPIO_Motor_Open_OnOff(m_GPIO_ON);
    f_Base_GPIO_Motor_Close_OnOff(m_GPIO_ON);
}
//===================================================================
...
/* LL GPIO AF initialize
-------------------------------------------------------------------*/
void f_Base_GPIO_Motor_Power_OnOff(te_GPIO_Output e_onoff)
{
    if(e_onoff == m_GPIO_OFF)
        { d_BASE_GPIO_MT_POWER_H; }
    else
        { d_BASE_GPIO_MT_POWER_L; }
}
//===================================================================
/* LL GPIO AF initialize
-------------------------------------------------------------------*/
void f_Base_GPIO_Motor_Open_OnOff(te_GPIO_Output e_onoff)
{
    if(e_onoff == m_GPIO_OFF)
        { d_BASE_GPIO_MT_OPEN_L; }
    else
        { d_BASE_GPIO_MT_OPEN_H; }
}
//===================================================================
/* LL GPIO AF initialize
-------------------------------------------------------------------*/
void f_Base_GPIO_Motor_Close_OnOff(te_GPIO_Output e_onoff)
{
    if(e_onoff == m_GPIO_OFF)
        { d_BASE_GPIO_MT_CLOSE_L; }
    else
        { d_BASE_GPIO_MT_CLOSE_H; }
}
//===================================================================
/* LL GPIO AF initialize
-------------------------------------------------------------------*/
void f_Base_GPIO_Main_Power_OnOff(te_GPIO_Output e_onoff)
{
        if(e_onoff == m_GPIO_OFF)
        { d_BASE_GPIO_MAIN_POWER_L; }
    else
        { d_BASE_GPIO_MAIN_POWER_H; }
}
//===================================================================
/* LL GPIO SW OK
-------------------------------------------------------------------*/
