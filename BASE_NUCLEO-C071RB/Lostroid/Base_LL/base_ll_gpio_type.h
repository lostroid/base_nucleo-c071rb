/********************************************************************
* File:    base_ll_gpio_type.h
* Author:  Lostroid
* Created: 2026-02-19
*
* Description:
* This is the LL(Low Level) gpio Type 
*
* Revision History:
*   2026-02-19  New.
---------------------------------------------------------------------
...
********************************************************************/
#ifndef H_LL_GPIO_TYPE_H
#define H_LL_GPIO_TYPE_H
...
#define d_GPIO_C10_MODE_DISABLE             d_GPIO_MODE_10(d_GPIO_MODE_OUTPUT)
#define d_GPIO_C11_MODE_DISABLE             d_GPIO_MODE_11(d_GPIO_MODE_OUTPUT)
#define d_GPIO_C12_MODE_DISABLE             d_GPIO_MODE_12(d_GPIO_MODE_OUTPUT)
#define d_GPIO_C13_MODE_DISABLE             d_GPIO_MODE_13(d_GPIO_MODE_OUTPUT)
